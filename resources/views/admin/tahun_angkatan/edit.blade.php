        ...
        <div class="{{ empty($sidebar) ? 'w-full' : 'flex-1' }} overflow-y-auto bg-gray-100 dark:bg-gray-900">
            <main class="w-full max-w-4xl p-4 mx-auto space-y-6 sm:p-6 lg:p-8">
                <x-header-create title="Edit Tahun Angkatan"
                    ...
                    :route="route('admin.tahun_angkatan.index')" breadcrumbActive="Edit Tahun" buttonText="Kembali" />
                ...
                <div
                    ...
                    <form action="{{ route('admin.tahun_angkatan.update', $tahunAngkatan) }}" method="POST"
                        class="p-6 space-y-2">
                        @csrf
                        @method('PUT')
                        <input type="hidden" name="user_id" id="user_id"
                            value="{{ old('user_id', $tahunAngkatan->user_id) }}">
