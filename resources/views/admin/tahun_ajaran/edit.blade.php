    ...
    <div class="flex flex-col min-h-screen overflow-hidden md:flex-row">
        ...
        <div class="{{ empty($sidebar) ? 'w-full' : 'flex-1' }} overflow-y-auto">
            <main class="w-full max-w-4xl p-4 mx-auto space-y-6 sm:p-6 lg:p-8">
                <x-header-create title="Edit Tahun Ajaran"
                    description="Perbarui informasi tahun ajaran." breadcrumbTitle="Tahun Ajaran"
                    :route="route('admin.tahun_ajaran.index')" breadcrumbActive="Edit Tahun" buttonText="Kembali" />
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex items-center space-x-2">
                                    @php
                                        [$startYear, $endYear] = explode('/', $tahunAjaran->tahun_ajaran);
                                    @endphp
                                    <input type="number" name="tahun_awal" id="tahun_awal"
                                        value="{{ old('tahun_awal', $startYear) }}" placeholder="2024" required
                                        min="2000" max="2100"
                                        class="w-1/2 text-sm block border-gray-300 rounded-lg shadow-sm focus:ring-indigo-100 focus:border-indigo-700 dark:bg-gray-700 dark:text-white dark:border-gray-600 @error('tahun_awal') border-red-500 ring-1 ring-red-500 @enderror">
                                    <span class="self-center">/</span>
                                    <input type="number" name="tahun_akhir" id="tahun_akhir"
                                        value="{{ old('tahun_akhir', $endYear) }}" placeholder="2025" required
                                        min="2000" max="2100"
                                        class="w-1/2 text-sm block border-gray-300 rounded-lg shadow-sm focus:ring-indigo-100 focus:border-indigo-700 dark:bg-gray-700 dark:text-white dark:border-gray-600 @error('tahun_akhir') border-red-500 ring-1 ring-red-500 @enderror">
                                </div>
                                ...
                                @error('tahun_akhir')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                                <p class="text-xs text-gray-500 dark:text-gray-400">Masukkan tahun mulai, tahun akhir
                                    akan otomatis terisi. Contoh: 2024 → 2025</p>
                            </div>
