        ...
        <div class="{{ empty($sidebar) ? 'w-full' : 'flex-1' }} overflow-y-auto bg-gray-100 dark:bg-gray-900">
            <main class="w-full max-w-4xl p-4 mx-auto space-y-6 sm:p-6 lg:p-8">
                <x-header-create title="Update Surah Al-Quran"
                    ...
                    breadcrumbTitle="Daftar Surah" :route="route('admin.surah.index')" breadcrumbActive="Update Surah" buttonText="Kembali" />
                ...
                <div class="overflow-hidden bg-white border border-gray-200 shadow-md rounded-xl dark:bg-gray-800 dark:border-gray-700">
                    <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                        <h2 class="text-lg font-semibold text-gray-800 dark:text-white">Informasi Surah</h2>
                    ...
                    <form action="{{ route('admin.surah.update', $surah->id) }}" method="POST" class="p-6 space-y-6">
                        @csrf
                        @method('PUT')
