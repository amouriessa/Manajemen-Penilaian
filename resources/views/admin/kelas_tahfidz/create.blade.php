                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            ...
                            <div class="space-y-2">
                                ...
                                <select name="tingkatan_kelas" id="tingkatan_kelas" required
                                    class="text-sm block w-full mt-1 border-gray-300 rounded-lg shadow-sm focus:ring-indigo-100 focus:border-indigo-700 dark:bg-gray-700 dark:text-white dark:border-gray-600 @error('tingkatan_kelas') border-red-500 ring-1 ring-red-500 @enderror">
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" name="nama" id="nama" placeholder="Contoh: A, B, C, Tahfidz" value="{{ old('nama') }}" required
                                    class="text-sm block w-full mt-1 border-gray-300 rounded-lg shadow-sm focus:ring-indigo-100 focus:border-indigo-700 dark:bg-gray-700 dark:text-white dark:border-gray-600 @error('nama') border-red-500 ring-1 ring-red-500 @enderror">
                                @error('nama')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="space-y-2">
                                ...
                                <select name="teacher_id" id="teacher_id" required
                                    class="text-sm block w-full mt-1 border-gray-300 rounded-lg shadow-sm focus:ring-indigo-100 focus:border-indigo-700 dark:bg-gray-700 dark:text-white dark:border-gray-600 @error('teacher_id') border-red-500 ring-1 ring-red-500 @enderror">
