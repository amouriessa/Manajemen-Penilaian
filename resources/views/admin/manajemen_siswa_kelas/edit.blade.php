                    ...
                    <form action="{{ route('admin.manajemen_siswa_kelas.update', $assignment->id) }}" method="POST"
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            <div class="space-y-2">
                                ...
                                class="block w-full mt-1 text-sm border-gray-300 rounded-lg shadow-sm cursor-not-allowed bg-gray-100 focus:ring-indigo-100 focus:border-indigo-700 dark:bg-gray-700 dark:text-white dark:border-gray-600" />
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <select name="kelas_tahfidz_id" id="kelas_tahfidz_id" required
                                    class="text-sm block w-full mt-1 border-gray-300 rounded-lg shadow-sm focus:ring-indigo-100 focus:border-indigo-700 dark:bg-gray-700 dark:text-white dark:border-gray-600 @error('kelas_tahfidz_id') border-red-500 ring-1 ring-red-500 @enderror">
                            ...
                            <div class="mb-4 space-y-2">
                                ...
                                <select name="tahun_ajaran_id" id="tahun_ajaran_id" required
                                    class="text-sm block w-full mt-1 border-gray-300 rounded-lg shadow-sm focus:ring-indigo-100 focus:border-indigo-700 dark:bg-gray-700 dark:text-white dark:border-gray-600 @error('tahun_ajaran_id') border-red-500 ring-1 ring-red-500 @enderror">
