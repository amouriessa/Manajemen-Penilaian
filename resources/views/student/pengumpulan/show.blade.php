                ...
                <div class="flex flex-col gap-4 mb-6 sm:flex-row sm:items-start sm:justify-between">
                    <div>
                        <div class="flex items-center gap-1.5 mb-2 text-xs text-[#8C8070]">
                            <a href="{{ route('student.tugas_hafalan.index') }}" class="hover:text-[#2D3F63] transition">Tugas Hafalan</a>
                            <svg class="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                            </svg>
                            <span class="font-medium text-[#3A3028]">Detail Nilai</span>
                        </div>
                        <h2 class="font-serif text-2xl font-bold text-textBody">Detail Penilaian Hafalan</h2>
                        <p class="mt-1 text-sm text-indigo-600">Nilai dan hasil penilaian tugas hafalan yang telah dikumpulkan.</p>
                            ...
                            <div class="p-6">
                                ...
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                    <div class="p-4 rounded-lg bg-[#e8f0fc] border border-[#E5DED6]">
                                        <p class="mb-1 text-xs font-medium uppercase tracking-wide text-[#8C8070]">Jenis Tugas</p>
                                        <p class="text-sm font-semibold text-[#3A3028]">{{ ucfirst($pengumpulan->tugasHafalan->jenis_tugas) }}</p>
                                    </div>
                                    <div class="p-4 rounded-lg bg-[#e8f0fc] border border-[#E5DED6]">
                                        <p class="mb-1 text-xs font-medium uppercase tracking-wide text-[#8C8070]">Tanggal Pengumpulan</p>
                            ...
                            <div class="overflow-hidden bg-[#FDFAF5] border border-[#E5DED6] shadow-md rounded-xl">
                                ...
                                <div class="p-6">
                                    <div class="flex items-center gap-3 pb-4 mb-6 border-b border-[#E5DED6]">
                                        ...
                                        <div>
                                            <h3 class="font-serif text-base font-bold text-textBody">Status Pengumpulan</h3>
                                    ...
                                    {{-- Audio Player --}}
                                    <div class="p-4 mb-5 rounded-xl bg-green-100 border border-[#E5DED6]">
                                        <p class="mb-3 text-xs font-semibold uppercase tracking-wide text-[#8C8070]">Audio Hafalan</p>

                                        <audio id="audioPlayer" class="hidden">
                                            <source src="{{ asset('storage/' . $pengumpulan->file_pengumpulan) }}" type="audio/mpeg">
                                            <source src="{{ asset('storage/' . $pengumpulan->file_pengumpulan) }}" type="audio/wav">
                                            <source src="{{ asset('storage/' . $pengumpulan->file_pengumpulan) }}" type="audio/ogg">
                                            <source src="{{ asset('storage/' . $pengumpulan->file_pengumpulan) }}" type="audio/webm">
                                        </audio>
                                        ...
                                        <div class="p-4 rounded-lg bg-[#FDFAF5] border border-[#E5DED6]">
                                            <div class="flex items-center gap-4">
                                                ...
                                                <button id="playPauseBtn"
                                                    ...
                                                    <svg id="pauseIcon" class="hidden w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                                ...
                                                <div class="flex-1 min-w-0">
                                                    ...
                                                    <div class="relative h-2">
                                                        ...
                                                        <div id="progressBar" class="absolute inset-y-0 left-0 rounded-full bg-[#2D3F63] transition-all duration-100" style="width:0%"></div>
                                                ...
                                                <div class="flex items-center flex-shrink-0 gap-2">
                                                    <button id="muteBtn" class="text-[#8C8070] hover:text-[#2D3F63] transition">
                                                        <svg id="volumeIcon" class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.536 8.464a5 5 0 010 7.072m2.828-9.9a9 9 0 010 12.728M5.586 15H4a1 1 0 01-1-1v-4a1 1 0 011-1h1.586l4.707-4.707C10.923 3.663 12 4.109 12 5v14c0 .891-1.077 1.337-1.707.707L5.586 15z"/>
                                                        </svg>
                                                        <svg id="muteIcon" class="hidden w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <div class="flex items-center justify-between pt-3 mt-3 border-t border-[#E5DED6]">
                                    ...
                                    @if ($pengumpulan->penilaian)
                                        <div class="p-5 rounded-xl bg-green-100 border border-[#E5DED6]">
                                            <div class="flex items-center gap-2 pb-4 mb-5 border-b border-[#E5DED6]">
                                                <svg class="w-4 h-4 text-green-600" fill="currentColor" viewBox="0 0 24 24">
                                                    <path d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"/>
                                                </svg>
                                                <h4 class="font-serif text-sm font-bold text-textBody">Hasil Penilaian</h4>
                                                <span class="ml-auto text-xs text-[#8C8070]">
                                                    Dinilai {{ \Carbon\Carbon::parse($pengumpulan->penilaian->assessed_at)->translatedFormat('d M Y') }}
                                                </span>
                                            </div>

                                            {{-- Nilai Total + Predikat --}}
                                            <div class="grid grid-cols-2 gap-4 mb-5">
                                                <div class="p-4 text-center rounded-lg bg-[#FDFAF5] border border-[#E5DED6]">
                                                    <p class="mb-1 text-xs font-medium uppercase tracking-wide text-[#8C8070]">Nilai Total</p>
                                                    <p class="font-serif text-2xl font-bold text-textBody">
                                                        {{ $pengumpulan->penilaian->nilai_total }}
                                                    </p>
                                                </div>
                                                <div class="p-4 text-center rounded-lg bg-[#FDFAF5] border border-[#E5DED6]">
                                                    <p class="mb-1 text-xs font-medium uppercase tracking-wide text-[#8C8070]">Predikat</p>
                                            ...
                                            <div class="overflow-hidden rounded-lg border border-[#E5DED6]">
                                                <table class="min-w-full divide-y divide-[#E5DED6]">
                                                    <thead>
                                                        <tr class="bg-[#FDFAF5]">
                                                            <th class="px-5 py-3 text-xs font-semibold uppercase tracking-wide text-left text-[#8C8070]">Aspek Penilaian</th>
                                                            <th class="px-5 py-3 text-xs font-semibold uppercase tracking-wide text-left text-[#8C8070]">Nilai</th>
                                                        </tr>
                                                    </thead>
                                            ...
                                            @if ($pengumpulan->penilaian->catatan)
                                                <div class="mt-4">
                                                    <p class="mb-2 text-xs font-semibold uppercase tracking-wide text-[#8C8070]">Catatan Guru</p>
                                                    <div class="p-4 rounded-lg bg-[#FDFAF5] border border-[#E5DED6]">
                                    ...
                                    @else
                                        {{-- Menunggu Penilaian --}}
                                        <div class="flex items-center gap-3 p-4 rounded-xl bg-[#FDF6EC] border border-[#D4A355]/30">
                                            <svg class="w-5 h-5 flex-shrink-0 text-[#D4A355]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                            </svg>
                                            <p class="text-sm font-medium text-[#B07833]">Menunggu penilaian dari guru.</p>
                                        </div>
                                    @endif
                                </div>
                            </div>
                        ...
                        @else
                            ...
                            <div class="overflow-hidden bg-[#FDFAF5] border border-[#E5DED6] shadow-md rounded-xl">
                                ...
                                <div class="p-10 text-center">
                                    <div class="flex items-center justify-center w-14 h-14 mx-auto mb-4 rounded-2xl bg-[#F9ECEC]">
                                        <svg class="w-7 h-7 text-[#B5655A]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.996-.833-2.464 0L3.34 16.5c-.77.833.192 2.5 1.732 2.5z"/>
                                        </svg>
                                    </div>
                                    <div class="w-12 h-0.5 bg-[#D4A355] rounded-full mx-auto mb-4"></div>
                                    <h3 class="mb-1 text-lg font-bold font-serif text-[#2D3F63]">Belum Mengumpulkan</h3>
                                    <p class="text-sm text-[#B5655A]">Anda belum mengumpulkan tugas ini.</p>
                            ...
                            <div class="p-5">
                                ...
                                <div class="space-y-3">
                                    <div class="p-3 rounded-lg bg-[#F7EDDA] border border-[#E5DED6]">
                                        <p class="mb-1 text-xs font-medium uppercase tracking-wide text-[#8C8070]">Nama Guru</p>
                                        <p class="text-sm font-semibold text-[#3A3028]">
                                            {{ $pengumpulan->tugasHafalan->guru->user->name ?? 'N/A' }}
                                        </p>
                                    </div>

                                    <div class="p-3 rounded-lg bg-[#F7EDDA] border border-[#E5DED6]">
                                        <p class="mb-1 text-xs font-medium uppercase tracking-wide text-[#8C8070]">Tugas Dibuat</p>
                                        <p class="text-sm text-[#3A3028]">
                                            {{ $pengumpulan->tugasHafalan->created_at->translatedFormat('d M Y, H:i') }}
                                        </p>
                                    </div>

                                    <div class="p-3 rounded-lg bg-[#F7EDDA] border border-[#E5DED6]">
                                        <p class="mb-2 text-xs font-medium uppercase tracking-wide text-[#8C8070]">Status</p>
                                        @if ($pengumpulan->penilaian)
                                            <span class="inline-flex items-center gap-1.5 px-3 py-1 text-xs font-medium rounded-full bg-[#EAF2EE] text-[#5C8270]">
                                                <span class="w-1.5 h-1.5 rounded-full bg-[#5C8270]"></span>
                                                Sudah Dinilai
                                            </span>
                                        @elseif ($pengumpulan)
                                            <span class="inline-flex items-center gap-1.5 px-3 py-1 text-xs font-medium rounded-full bg-[#FDF6EC] text-[#B07833]">
                                                <span class="w-1.5 h-1.5 rounded-full bg-[#D4A355] animate-pulse"></span>
                                                Menunggu Penilaian
                                            </span>
                                        @else
                                            <span class="inline-flex items-center gap-1.5 px-3 py-1 text-xs font-medium rounded-full bg-[#fcd2d2] text-[#B5655A]">
