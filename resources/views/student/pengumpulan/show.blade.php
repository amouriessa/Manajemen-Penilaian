        ...
        <div class="flex flex-col items-start justify-between gap-4 mb-6 sm:flex-row sm:items-center">
            <div>
                <div class="flex items-center gap-2 mb-1 text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <span class="font-medium text-gray-700 dark:text-gray-300">Detail Nilai</span>
                </div>
                <h1 class="text-xl font-bold text-gray-800 dark:text-white md:text-2xl">Detail Penilaian Tugas Hafalan
                </h1>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Menampilkan nilai dari tugas hafalan yang telah
                    dikumpulkan.</p>
            </div>
            <a href="{{ route('student.tugas_hafalan.index') }}"
                    ...
                    <div class="p-6 sm:p-8">
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            <div>
                                ...
                                <p class="text-lg font-semibold text-gray-900 dark:text-white">
                                    {{ ucfirst($pengumpulan->tugasHafalan->jenis_tugas) }}
                                </p>
                            </div>

                            <div>
                                <div class="flex items-center mb-2">
                                    <span class="text-sm text-gray-500 dark:text-gray-400">Tanggal Pengumpulan</span>
                                </div>
                                <p class="text-lg font-semibold text-gray-900 dark:text-white">
