                    ...
                    <form action="{{ route('teacher.penilaian.pengumpulan.update', $pengumpulan) }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="catatan" id="catatan" rows="4"
                                class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-100 focus:border-indigo-700 dark:bg-gray-700 dark:border-gray-600 dark:text-white">{{ old('catatan', $penilaian->catatan) }}</textarea>
                            @error('catatan')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
